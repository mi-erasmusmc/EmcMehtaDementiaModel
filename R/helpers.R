getAnalyses <- function(settings, outputFolder,cdmDatabaseName){
  ...
  cohorts <- system.file("settings", 'CohortsToCreate.csv', package = "EmcMehtaDementiaModel")
  cohorts <- read.csv(cohorts)
  
    settingLoc <- system.file("settings","settings.csv", package = "EmcMehtaDementiaModel")
...
getPopulationSettings <- function(){
  ...
  runSettingsLoc <- system.file("settings", 'existingModelList.json', package = "EmcMehtaDementiaModel")
