...
OhdsiRTools::checkUsagePackage("EmcMehtaDementiaModel")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/EmcMehtaDementiaModel.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EmcMehtaDementiaModel.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "EmcMehtaDementiaModel")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EmcMehtaDementiaModel")
